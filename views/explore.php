...
<body class="bg-gray-100 min-h-screen">
        ...
        <div class="container mx-auto px-4">
            <div class="flex h-16 items-center justify-between">
                ...
                <nav class="flex items-center gap-4">
                    <a href="<?= BASE_URL ?>" class="text-gray-600 hover:text-blue-600 transition">Trang chủ</a>
                    <a href="<?= BASE_URL ?>/login" class="px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition">Đăng nhập</a>
                    <a href="<?= BASE_URL ?>/register" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">Đăng ký</a>
                </nav>
            </div>
        </div>
    </header>
    ...
    function openPlayerModal(audio) {
        ...
        document.getElementById('modal-category').textContent = `${audio.category_icon} ${audio.category_name}`;
